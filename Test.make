...
ifeq ($(config),debug)
  ...
  OBJDIR = bin/Debug/obj/Test
  DEFINES += -DDEBUG
  INCLUDES += -Ivendor/v8/include -Ivendor/spdlog/include -Isrc
  FORCE_INCLUDE +=
  ...
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -shared -Wl,-soname=libTest.so
